...
// Scrivete un programma in cui usate i puntatori per accedere alle locazioni di variabili.
// Siete incoraggiati a migliorare i messaggi di stampa minimali proposti nell’esercizio
// in modo da capire più facilmente quali valori state stampando, ad esempio
// aggiungendo frasi come indirizzo di s1 == oppure valore di p ==.

// [SUGGERIMENTO: Per stampare gli indirizzi (riferimenti a variabili e valore di puntatori) in maniera leggibile, bisogna
// usare static_cast<void*>(...) mettendo l’indirizzo al posto dei puntini.]
...
int main()
{
	...
	cout << "Debug: " << &s1 << " " << &s2 << endl << s1 << " " << s2 << endl;
